          ...
          <div className="flex">
            ...
            <div id="Headline-div" className="overflow-x-hidden custom-gradient py-0 md:py-2 flex-1">
              <Marquee className="py-2" pauseOnHover={true} speed={100}>
                {Array.isArray(data) &&
                  data.map((item, index) => (
                    <span key={index} className="md:text-lg text-xs mx-6 text-yellow-900 font-bold inline-block ml-5">
                      <img src="/star.svg" alt="Star" className="inline-block md:w-6 md:h-6 w-4 h-4 mr-2"/>
                      {item.description}
                    </span>
                  ))}
              </Marquee>
