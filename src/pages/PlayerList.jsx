    ...
    <div className="mx-auto py-8">
      ...
      <div className="container mx-auto overflow-x-auto">
        {loading ? (
          ...
          <div role="status">
    <svg aria-hidden="true" class="inline w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-[#2C1B16]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <table className="min-w-full bg-[#2C1B16] border-x-2 border-[#2C1B16] rounded-lg shadow-md">
            ...
            <tbody className="bg-[#F8F4E1] divide-y divide-gray-400">
              {sortedData.map((item, index) => (
                <tr key={index}>
                  <td className="px-6 py-4 border-x-2 border-[#2C1B16] whitespace-nowrap text-sm font-semibold text-neutral-700">
                    {item.Name}
                  </td>
                  <td className="px-6 py-4 border-x-2 border-[#2C1B16] whitespace-nowrap text-sm font-semibold text-neutral-700">
                    {item.FideId}
